/*
  ...
  - You are about to alter the column `value_buy` on the `Actives` table. The data in that column could be lost. The data in that column will be cast from `String` to `Decimal`.
